...
import { Home, Search, Plus, MessageCircle, User, Package, Store, Car, ShoppingBag, Wallet, UtensilsCrossed } from "lucide-react";
...
const ALL_TABS: NavTab[] = [
  ...
  { href: "/food", icon: UtensilsCrossed, label: "مطاعم", auth: false },
