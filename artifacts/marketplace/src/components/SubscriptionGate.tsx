...
const BENEFITS = [
  {
    ...
    title: "منتجاتك مرئية لملايين المشترين",
    desc: "بدون اشتراك منتجاتك مخفية تماماً — الاشتراك يجعلها تظهر لكل مستخدمي التطبيق فوراً",
  },
  {
    icon: BadgeCheck,
    color: "text-blue-400",
    bg: "bg-blue-400/10 border-blue-400/20",
    title: "شارة توثيق ذهبية ✓",
    desc: "حسابك يحصل على شارة التوثيق التي تكسب ثقة العملاء وتزيد المبيعات بنسبة 3 أضعاف",
  },
  {
    icon: TrendingUp,
    color: "text-green-400",
    bg: "bg-green-400/10 border-green-400/20",
    title: "أولوية في قسم المنتجات الرائجة",
    desc: "منتجاتك تتصدر نتائج البحث وتظهر في أبرز قسم على التطبيق وتصل لآلاف المشترين يومياً",
  },
  {
    icon: Zap,
    ...
    desc: "فريق الدعم يعطيك الأولوية في كل طلب، وإشعارات فورية عند كل رسالة أو طلب منتج",
  },
];
    ...
    <>
      <div className="flex flex-col min-h-[85vh] px-5 pb-10 overflow-y-auto" dir="rtl">
        ...
        <div className="pt-10 pb-6 text-center">
          ...
          >
            متجرك موقوف مؤقتاً — منتجاتك مخفية عن المشترين حالياً<br />اشترك وأعرض منتجاتك للملايين مجاناً
          </motion.p>
        </div>
